...
| Mode 1 (`10011` … `11330`) | 30 | **ยังเป็นโครงเปล่า** `RESET_STEP(), END_STEP()` |

โครงเปล่าหมายถึงกดแล้วได้แค่รีเซ็ตพิกัด + zero gyro + สั่ง lift home แล้วขึ้น
`MISSION FINISHED` ทันที ไม่มีการเคลื่อนที่ใด ๆ
