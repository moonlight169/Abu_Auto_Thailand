...
void printHelp() {
  ...
  Serial.println("R2 ON/OFF ... R4     Relay 2-4");
  ...
  Serial.println("LIDAR ON              Realtime summary + box bar");
  Serial.println("LIDAR OFF             Stop USB LiDAR reporting");
  Serial.println("LIDAR STATUS          Print one LiDAR result");
  Serial.println("LIDAR RESET           Reset detection filter");
  Serial.println("MODE BOX              Find box distance/center/angle");
  Serial.println("MODE WALL             Find front plane distance/angle");
  Serial.println("MODE?                  Show active LiDAR mode");
  Serial.println("M1 / M2 / M3          Summary / bar / CSV points");
  Serial.println("D450                  Score target distance 450 mm");
  Serial.println("A0.45                 Filter alpha 0.45");
  Serial.println("T250                  Print interval 250 ms");
  Serial.println("HELP                  Show commands");
  Serial.println("--- MASTER Serial1 commands ---");
  ...
  Serial.println("GET TFMINI            TFMini 1/2/3/4 distance in cm");
