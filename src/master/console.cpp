...
void printHelp()
{
  Serial.println("=== TEENSY -> STM32 MECANUM TEST ===");
  ...
  Serial.println("100e : rotate CCW 100 RPM");
  Serial.println("100f : rotate CW 100 RPM");
  ...
  Serial.println("M1 / M2      : select and start mission 1 or 2");
  Serial.println("SEL 1 / 2    : select mission without starting");
  Serial.println("A            : abort mission sequence");
  ...
  Serial.println("R1 ON/OFF    : control Hub relay 1..4");
  Serial.println("ARM 40       : Hub ARM servo (0..80 deg)");
  Serial.println("SPIN 100     : Hub SPIN servo (0..133 deg)");
  Serial.println("AH           : external Arm home");
  Serial.println("AB 90        : external Arm bottom axis to 90 deg");
  Serial.println("AT 45        : external Arm top axis to 45 deg");
  Serial.println("AP 90 45     : external Arm bottom=90, top=45 deg");
  Serial.println("AS           : request external Arm status");
  Serial.println("HOME         : Arm home (direct protocol)");
  Serial.println("POS,90,45    : Arm bottom=90, top=45");
  Serial.println("B,90 / T,45  : move one Arm axis");
  Serial.println("STATUS       : request Arm status");
  Serial.println("STOP / CLEAR : stop Arm / clear Arm fault");
  Serial.println("V,0,0,0 or G,0,0,0 : normal soft stop");
  Serial.println("s    : immediate/emergency stop");
  Serial.println("v    : link and target status");
  Serial.println("z    : zero Teensy odometry");
  Serial.println("q    : request feedback now");
